    ...
    return (
        <>
            <div
                ...
                <div class="flex -space-x-2 w-fit p-2 border items-center border-black rounded-full dark:border-amber-50">
                    <img
                ...
                <h1 className="text-4xl sm:text-5xl md:text-6xl xl:text-[84px] font-medium max-w-5xl">
                ...
                <p className="text-sm sm:text-lg font-medium text-gray-500 dark:text-white/75 max-w-4/5 sm:max-w-1g pb-3">
